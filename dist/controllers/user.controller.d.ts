...
export declare class UserController {
    ...
    constructor(userRepository: UserRepository, generoRepository: GeneroRepository, clienteRepository: ClienteRepository, clienteGeneroRepository: ClienteGeneroRepository, passwordHasher: PasswordHasher, jwtService: TokenService, userService: UserService<User, Credentials>);
